...
+
https://raw.githubusercontent.com/jerry2605/Automation_DevOps_Using_Jenkins/master/files/module3/Dockerfile[Dockerfile]
+
----
wget https://raw.githubusercontent.com/jerry2605/Automation_DevOps_Using_Jenkins/master/files/module3/Dockerfile
----
