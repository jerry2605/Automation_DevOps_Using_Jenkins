...
+
https://github.com/jerry2605/Automation_DevOps_Using_Ansible/blob/master/files/module3/Dockerfile[Dockerfile]
+
----
wget https://raw.githubusercontent.com/jerry2605/Automation_DevOps_Using_Ansible/master/files/module3/Dockerfile
----
